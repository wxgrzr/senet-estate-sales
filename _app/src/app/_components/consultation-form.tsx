    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      <div>
        ...
        <input
          ...
          name="name"
          id="name"
          className="bg-white focus:outline-ship-cove-600 block w-full rounded-lg border border-stone-300 p-2.5 text-sm shadow-sm focus:outline-2"
      ...
      <div>
        ...
        <textarea
          ...
          id="message"
          rows={4}
          className="bg-white focus:outline-ship-cove-600 block w-full rounded-lg border border-neutral-300 p-2.5 text-sm shadow-sm focus:outline-2"
